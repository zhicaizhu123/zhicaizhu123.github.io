...
## SouuceTree功能区
![](https://user-gold-cdn.xitu.io/2018/12/25/167e2df3f0ccae9b?w=1352&h=725&f=png&s=212435)           

<!--## 工具导航栏-->
<!--![](https://user-gold-cdn.xitu.io/2018/12/25/167e2e267287ed96?w=830&h=53&f=png&s=8472)-->
<!--- 提交 -> git commit ...-->
<!--- 拉取 -> git pull ...-->
<!--- 推送 -> git push ...-->
<!--- 获取 -> git fetch ...-->
...
首次开发项目，从远程获取分支：      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e33e3140d9619?w=1351&h=698&f=png&s=169666)      
    检出为本地分支：            
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e33d5b14b23d1?w=1341&h=691&f=png&s=172676)          
    如果是远程的环境分支我们一般需要“跟踪远程分支”，方便我们知道远程分支是否已经更新了修改      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e362966d31f55?w=1349&h=540&f=png&s=138954)      
    如果有未推送和未拉取的远程更新，在相应的位置会显示条目      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3654005dd6bb?w=1354&h=480&f=png&s=149542)      
    
创建feature/fixbug分支：            
    1. 双击master，切换到master分支，拉取master线上最新代码；    
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3402a7678211?w=1351&h=665&f=png&s=168761)      
    2. 从master主分支创建功能分支feature(例如：2018-10-01_version_2.3)     
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e341af21fcbd4?w=1356&h=669&f=png&s=165937)      

## 修改和提交分支
如果我们在feature/fixbug分支新增/删除文件或者修改文件等时，界面会提示你当前有未提交的修改       
![](https://user-gold-cdn.xitu.io/2018/12/25/167e34b22069fde4?w=1350&h=691&f=png&s=151670)      
接着我们可以将修改的内容加入暂存区和历史版本    
![](https://user-gold-cdn.xitu.io/2018/12/25/167e34e797e70784?w=1349&h=677&f=png&s=165437)      
![](https://user-gold-cdn.xitu.io/2018/12/25/167e34f9629556a2?w=1353&h=666&f=png&s=79239)       

## 合并分支
合并分支前，需要拉取先拉取目标分支最新代码到本地分支，例如需要把`2018-10-01_version_2.3`分支合并到`master`分支，我们需要先拉取`master`的远程库的最新代码    
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3fe5bbf6ffb3?w=1206&h=414&f=png&s=97961)       
合并分支要到目标分支上去操作，比如我们要把分支`2018-10-01_version_2.3`上的修改合并到`master`分支，那么我们就要到`master`分支上去操作。       
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3274be0a911b?w=1351&h=386&f=png&s=110652)      
![](https://user-gold-cdn.xitu.io/2018/12/25/167e329a74b43fd8?w=1329&h=574&f=png&s=132538)      
- 合并过程发生冲突      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e32c369377f1f?w=1342&h=664&f=png&s=161418)      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e32cc75877d87?w=758&h=170&f=png&s=23033)        
    处理冲突后，标记为已解决（[解决冲突的方法可以参考](#冲突和解决方式)）      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e32e4190d7987?w=1145&h=565&f=png&s=137236)      
    提交修改        
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e32f613899bfb?w=1360&h=568&f=png&s=136410)      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3300f5a7e481?w=1358&h=665&f=png&s=79670)       
    提交信息默认为发生冲突的文件路径        
- 合并过程没有冲突      
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e35523b534a83?w=1344&h=692&f=png&s=171991)      
...
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3f643fdc6b84?w=1036&h=402&f=png&s=95708)       

如果没有自动推送到远程库的话，日后可以在标签列表里进行推送      
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3fbb732aec98?w=1017&h=512&f=png&s=105538)      

## 版本回退
如果开发过程中发现当前已经提交的版本有问题回滚到上一个版本或者指定版本。    
假如当前提交的版本2.0有问题，需要回退到版本1.0
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3d6fb611f1b6?w=1041&h=474&f=png&s=124060)     
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3da60476130d?w=1023&h=336&f=png&s=101160)
...
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3868982f1c7c?w=1352&h=598&f=png&s=157669)      
- 使用 “我的版本” 或 “他人版本” 来解决    
    这是修复 git 中的合并冲突最简单的方式。右击任意有冲突的文件     
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3c5f2bcda53d?w=1046&h=619&f=png&s=141663)
...
- 手动编辑方法解决
    ...
    修改前：    
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3c77da6cb319?w=999&h=192&f=png&s=26553)
    修改后：    
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3c85f32ddfec?w=914&h=197&f=png&s=20660)
    修改完后回到SourceTree，在 “未暂存文件” 区域里选择冲突的文件。拖到上面的 “已暂存文件” 区域里面。或者也可以右击文件，然后选择 “解决冲突 -> 标记为已解决”。   
    - 点击“暂存”按钮    
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3cb15780c7b5?w=1039&h=546&f=png&s=112640)    
    - 标志为已解决    
    ![](https://user-gold-cdn.xitu.io/2018/12/25/167e3c9c0299fc9b?w=1037&h=559&f=png&s=122466)      
- 合并过程中失误解决方式  
...
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3703236ebab6?w=1331&h=253&f=png&s=27834)         
所以我们需要先把修改内容贮藏起来
![](https://user-gold-cdn.xitu.io/2018/12/25/167e372eb537fd19?w=1337&h=540&f=png&s=141333)      
贮藏成功后我们就会在贮藏列表看到我们刚刚贮藏的内容      
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3741cd3a7aa1?w=1362&h=597&f=png&s=171231)      
如果我们开发完其它任务后，切换到之前的功能分支，只需要把之前贮藏的内容提取出来就可以继续开发，提取后最好同时删除这次贮藏        
![](https://user-gold-cdn.xitu.io/2018/12/25/167e3777ae6d4a50?w=1354&h=530&f=png&s=186286)      
应用成功后我们就会在图谱上看到我们之前的未提交更改，同时之前的贮藏也会贮藏列表移除      
![](https://user-gold-cdn.xitu.io/2018/12/25/167e37916cacb003?w=1345&h=496&f=png&s=130965)
