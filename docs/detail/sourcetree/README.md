...
- 使用 git 客户端生成私钥公钥 id_rsa、id_rsa.pub：
    ...
    git config --global user.email "xxx@tzdtz.com"
    
    // 2. 生成 SSH 密钥, 按3个回车，密码为空
    ssh-keygen -t rsa -C "xxx@tzdtz.com"
    ```
- 使用SourceTree, 通过 “工具 -> 选项 -> 一般” 进入设置界面    
        
    <a data-fancybox title="" href="https://user-gold-cdn.xitu.io/2019/1/5/1681b9942abb291a?w=1364&h=237&f=png&s=69506">![](https://user-gold-cdn.xitu.io/2019/1/5/1681b9942abb291a?w=1364&h=237&f=png&s=69506)</a>
    添加密钥：
